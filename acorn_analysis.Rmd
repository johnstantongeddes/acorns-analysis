...
oak.ts <- with(statsdata, aggregate(acorn_count ~ year, FUN=mean))
oak.ts <- ts(oak.ts$acorn_count, start=1994, end=2011)
...
plot(oak.ts, lwd=2, ylim=c(0, 3.5))
lines(x=1994:2011, y=predict(mod.ols), col="purple", lty=1)
lines(x=1994:2011, y=predict(mod.ols4), col="blue", lty=2)
lines(x=1994:2011, y=predict(mod.ols.AIC), col="red", lty=2)
lines(x=1994:2011, y=predict(mod.ols.min), col="green", lty=2)
```
